...
fn contains_key_true_for_inserted_prefix() {
    ...
    trie.insert((0b000001_000001_000000_000000_000000_00u32, 12), 12);
    assert!(
        trie.contains_key((0b000001_000001_000000_000000_000000_00u32, 12))
    );
}
...
fn contains_key_false_for_different_prefix_length() {
    ...
    trie.insert((0b000001_000001_000000_000000_000000_00u32, 12), 12);
    assert!(
        !trie.contains_key((0b000001_000001_000000_000000_000000_00u32, 11))
    );
    assert!(
        !trie.contains_key((0b000001_000001_000000_000000_000000_00u32, 13))
    );
}

#[test]
fn contains_key_false_on_empty_trie() {
    let trie = Poptrie::<_, ()>::new();
